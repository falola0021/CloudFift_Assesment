      ...
      <Container>
        <Row>
          ...
          <div className={Styles.inputBox}>
            <input className={Styles.input1} placeholder='Enter keywords, skill, interest' />
            <IoLocationOutline className={Styles.location} />
            <input className={Styles.input2} placeholder='location' />
            <span className={Styles.searchBox}><BiSearchAlt className={Styles.search}/></span>
          </div>
          <div className={Styles.bottomVal}>
            <div className={Styles.trustBy}>
              Trusted by
            </div>
            <div className={Styles.trustImageBox}>
              <img className={Styles.trustImagep} src={PaystackFaded} alt='image' />
              <img className={Styles.trustImageg} src={GoogleFaded} alt='image' />
              <img className={Styles.trustImagek} src={KpmgFaded} alt='image' />
            </div>
          </div>
          </Col>
