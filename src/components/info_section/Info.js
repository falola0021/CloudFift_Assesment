...
export default function Info() {
  return (
    <Row xs={1} md={1} lg={2} className={Style.container}>
      <Col>
        ...
        <div className={Style.text1}>
          Over 1000+ jobs from top companies in our network Every day we index
          millions of jobs directly from employer websites. We’re committed to
          accurate, high-quality jobs so you won’t find old, duplicated, or
          spammy listings here. Organize and automate your job search while at
          home or on the go. We’ll deliver new, relevant jobs of interest
          straight to your inbox. Learn More
        </div>
        <div className={Style.text1}></div>
        <div className={Style.learn}>
          <div className={Style.learntext}>Learn more</div>
