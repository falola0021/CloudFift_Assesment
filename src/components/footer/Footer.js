...
export default function Footer() {
  return (
    <Container fluid className={Styles.footerContainer}>
      <Row>
        <Col md={{ span: 3, offset: 0 }} sm={{ span: 4, offset: 4 }}>
        ...
        <Col>
          <div className={Styles.header}>Job Seekers</div>
          <div className={Styles.subHead}>
            <div className={Styles.text}>Create Account</div>
            <div className={Styles.text}>Job List</div>
            <div className={Styles.text}>FAQ</div>
          </div>
        </Col>
        <Col>
          <div className={Styles.header}>Employers</div>
          <div className={Styles.subHead}>
            <div className={Styles.text}>Create Account</div>
            <div className={Styles.text}>Post a Job</div>
            <div className={Styles.text}>FAQ</div>
          </div>
        </Col>
        <Col>
